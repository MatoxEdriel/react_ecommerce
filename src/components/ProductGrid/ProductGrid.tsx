      ...
      {products.map((product) => (
        <li key={product.id}>
          <Link
            ...
            className="flex h-full flex-col items-start gap-2 rounded-xl border border-line bg-card p-5 text-left transition-shadow hover:shadow-lg hover:shadow-secondary-soft"
          >
